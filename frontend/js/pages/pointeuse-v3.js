(function () {
  ...
  async function renderBody(){
    ...
    const body=root.querySelector('.p3-body'); body.innerHTML='<div class="p3-empty">Chargement…</div>';
  ...
  function render(){
    ...
    const mode=state.capabilities?.mode||'shadow'; t.classList.toggle('pointeuse-v3-active',mode==='active');
